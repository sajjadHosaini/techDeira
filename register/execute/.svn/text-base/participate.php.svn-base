...
//Array to store validation errors
	...
	$password = md5($pass);
	//Create INSERT query
	$qry = "INSERT INTO users VALUES (null,'$email','$password','".$_POST['fnamefield']."','".$_POST['lnamefield']."','participant')";
	$result = mysql_query($qry);
...
if($result) {
		...
		echo $row[0];
		$qry2 = "INSERT INTO participants VALUES('$row[0]','".$_POST['titlefield']."','".$_POST['dob']."','".$_POST['gender']."','".$_POST['cphone']."','".$_POST['lphone']."','".$_POST['houseno']."','".$_POST['emailadd']."','".$_POST['streetno']."'
			...
			,'".$_POST['csa']."','".$_POST['os']."','".$_POST['tw']."','".$_POST['other-member']."','".$_POST['other-member-web']."')";
