...
include 'header.php';
?>
	<h1 style="margin-top:80px;">Online Entrepreneur Workshop</h1>
	<h5>Please, fill out this form to participate at the Online Entrepreneur Workshop by TechNation at the TechDeira. </h5>
	<div class="well blue">
                            ...
                            <div class="well-content no-search">
                                <form id="commentForm" method="post" action="execute/trainee_abade.php" class="form-horizontal">
				<div id="rootwizard">
					<ul>
					  	<li><a href="#tab1" data-toggle="tab" class="dis">1. <span class="hidden-phone">Personal Infromation</span></a></li>
						<li><a href="#tab2" data-toggle="tab" class="dis">2. <span class="hidden-phone">Social (Optional)</span></a></li>
						<li><a href="#tab3" data-toggle="tab" class="dis">3. <span class="hidden-phone">Educational Background</span></a></li>
						<li><a href="#tab4" data-toggle="tab" class="dis">4. <span class="hidden-phone">Organizational Affiliation</span></a></li>						
						<li><a href="#tab5" data-toggle="tab" class="dis">5. <span class="hidden-phone">Experience/Core Capabilities</span></a></li>						
						<li><a href="#tab6" data-toggle="tab" class="dis">6. <span class="hidden-phone">Finalize</span></a></li>
					</ul>
					    ...
					    <div class="tab-pane" id="tab1">
							...
							<h3><small class="hidden-desktop">Step 1/6 </small>Personal Information</h3>
					    	  ...
					    	  <div class="control-group">
							    ...
							    <div class="controls">
							      <p><input type="text" name="surnamefield" placeholder="* Surname" class="input-xlarge required"></p>
							      <p><input type="text" name="fnamefield" placeholder="* First Name" class="input-xlarge required"></p>
							    </div>
							  </div>
							  <div class="control-group">
							  ...
							  <div class="control-group">
							    ...
							    <div class="controls">
							      <input type="radio" name="gender" class="title" value="Male"> Male &nbsp; &nbsp; &nbsp; &nbsp;
							      <input type="radio" name="gender" class="title" value="Female" checked> Female &nbsp; &nbsp; &nbsp; &nbsp;
							    </div>
							  </div>
							  <div class="control-group">
