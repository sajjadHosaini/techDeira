...
include 'header.php';
?>
	<h1 style="margin-top:80px;">Trainee Registration</h1>
	<h5>Please, fill out this form to participate at the ABADE Web Development Training by TechNation at the TechDeira. </h5>
	<div class="well blue">
