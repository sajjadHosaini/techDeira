...
include 'header.php';
?>
	<h1 style="margin-top:80px;">Become a Participant</h1>
	<h5>By participating in our events you will be able to join courses running in TechDeira and other activities</h5>
	<div class="well orange">
                            <div class="well-header">
                                <h5>Participant Registeration Form</h5>
                            </div>

                            <div class="well-content no-search">
                                <form id="commentForm" method="post" action="execute/participate.php" class="form-horizontal">
				<div id="rootwizard">
					<ul>
						...
						<li><a href="#tab5" data-toggle="tab" class="des">5. <span class="hidden-phone">Finalize</span></a></li>
					</ul>
					...
					<div class="tab-content">
					    <div class="tab-pane" id="tab1">
							...
							<h3><small class="hidden-desktop">Step 1/5 </small>Personal Information</h3>
							<br>
	...
	<!-- TAB 2 ---------------------------------- SOCIAL------------------------------------------------- -->
						...
						<h3><small class="hidden-desktop">Step 2/5 </small>Social (Optional)</h3>
						<br>
					    <div class="control-group">
...
<!-- TAB 3 ---------------------------------- EDUCATION ------------------------------------------------- -->
						...
						<h3><small class="hidden-desktop">Step 3/5 </small>Educational Background</h3>
						<br>
					    <div class="control-group">
...
<!-- TAB 4---------------------------------- ORGANIZATION ------------------------------------------------- -->
						...
						<h3><small class="hidden-desktop">Step 4/5 </small>Organizational Affiliation</h3>
						<br>
					    <div class="control-group">
							    <label class="control-label" for="email">Title</label>
							    <div class="controls">
...
<!-- TAB 5---------------------------------- FINAL ------------------------------------------------- -->
						...
						<h3><small class="hidden-desktop">Step 5/5 </small>Congratulations!</h3>
