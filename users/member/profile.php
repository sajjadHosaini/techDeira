...
$sql=mysql_query("select * from participants where emailadd='" . $rowuser['email_id'] . "'");
...
<span class="col-md-6"> 
<label class="radio-inline">
Academia<input type="radio" name="org_nature" value="Academia"
 <?php 
...
<br/>
<label class="radio-inline">
Inter governmental<input type="radio" name="org_nature" value="Inter governmental"
 <?php 
...
<br/>
<label class="radio-inline">
Other<input type="radio" value="other" name="org_nature"
 <?php 
if($org_nature=='other'){
echo "checked";
}?>
