			...
			<div id="sidebar-left" class="col-lg-2 col-sm-1">
				<div
					...
					<ul class="nav nav-tabs nav-stacked main-menu">
						<li class="active"><a href="#"><i class="fa fa-bar-chart-o"></i><span class="hidden-sm"> Dashboard</span></a></li>
						<li><a href="courses.php"><i class="fa fa-laptop"></i><span
								class="hidden-sm"> Courses</span></a></li>
						<li><a href="profile.php"><i class=" fa fa-user fa-lg"></i><span class="hidden-sm"> Profile</span></a></li>
						<li>
					</ul>
				</div>
			</div>
